    ...
    <main className="min-h-screen bg-[#F8FAFC] selection:bg-blue-600 selection:text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="prose prose-slate max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tight space-y-8 text-slate-600 text-sm md:text-base leading-relaxed">
          <section>
            <h2 className="text-xl md:text-2xl text-slate-900 mb-4 border-l-4 border-blue-600 pl-4">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl text-slate-900 mb-4 border-l-4 border-blue-600 pl-4">2. CCTV and Photographic Data</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl text-slate-900 mb-4 border-l-4 border-blue-600 pl-4">3. Data Sharing and Airport Authorities</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl text-slate-900 mb-4 border-l-4 border-blue-600 pl-4">4. Data Retention</h2>
