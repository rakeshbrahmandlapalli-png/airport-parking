...
export const metadata: Metadata = {
  ...
  description:
    "Compare trusted Luton Airport (LTN) Meet & Greet and Park & Ride parking. Fully insured, free cancellation, 4.8★ rated. Drive to the terminal, hand over your keys, and fly. Book in under 60 seconds.",
  ...
  return (
    <HomePage
      preset={{
        ...
        intro:
          "Licenced Meet & Greet and Park & Ride at Luton Airport (LTN). Drive straight to the terminal forecourt, hand over your keys, and fly — no shuttle buses, no long walks. Fully insured operators, free cancellation, 4.8★ rated.",
      }}
    />
  );
}
