...
export const metadata: Metadata = {
  ...
  description:
    "Compare trusted Heathrow Airport (LHR) Meet & Greet and Park & Ride parking across Terminals 2, 3, 4 and 5. Fully insured, free cancellation. Book in under 60 seconds.",
  ...
  return (
    <HomePage
      preset={{
        ...
        intro:
          "Meet & Greet and Park & Ride at Heathrow Airport (LHR) across Terminals 2, 3, 4 and 5. Drive to departures, hand over your keys, and fly stress-free. Fully insured operators, free cancellation.",
      }}
    />
  );
}
